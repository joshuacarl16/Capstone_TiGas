...
//             child: Container(
//               color: Colors.green,
//               height: deviceHeight * 0.08, // Increased height for better visibility and touch
//               child: Center(
...
//             right: 20.0,
//             child: IconButton(
//               icon: Icon(Icons.close, size: deviceHeight * 0.03),
//               onPressed: () {
...
class _RateDialogState extends State<RateDialog> {
  ...
  Future<void> postReview(String? comments, rating, List<String> review) async {
    ...
    try {
      ...
      postedBy = (snapshot.data() as Map<String, dynamic>?)?['displayname'];
    } catch (e) {
      postedBy = 'Unknown';
    }
